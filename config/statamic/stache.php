    ...
    */
    ...
    'stores' => [
        ...
        'taxonomies' => [
            ...
            'directory' => base_path('resources/config/taxonomies'),
        ],
        ...
        'collections' => [
            ...
            'directory' => base_path('resources/config/collections'),
        ],
        ...
        'navigation' => [
            ...
            'directory' => base_path('resources/config/navigations'),
        ],
        ...
        'asset-containers' => [
            ...
            'directory' => base_path('resources/config/assets'),
        ],
